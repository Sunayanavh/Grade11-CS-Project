...
is Red Square, Russia's \n symbolic center. It's home to Lenin’s Mausoleum, the State Historical Museum's \n comprehensive\
 collection and St. Basil’s Cathedral, known for its colorful, onion-shaped domes.",
    bg = 'salmon1',
    fg = 'grey35',
...
Hotel National, Moscow(4.6) - Rs 13,618\n\
