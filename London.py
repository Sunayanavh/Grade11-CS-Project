...
label2 = tk.Label(
    text = "London, the capital of England and the United Kingdom, \
is a 21st-century city with history\n stretching back to Roman times. At its\
centre stand the imposing Houses of Parliament, the \n iconic ‘Big Ben’ \
...
test1 = ImageTk.PhotoImage(Image.open('london1.jpg'))
labelimg1 = tk.Label(image=test1)
labelimg1.place(relx=0.9,rely=0.95,anchor='se')

test2 = ImageTk.PhotoImage(Image.open('london2.jpg'))
...
label3 = tk.Label(
    text = 'Four Seasons Hotel London (5.0) - Rs 97,329\n\
London Marriott (4.5) - Rs 42,832\n\
The Montcalm Royal London House (4.7) - Rs 19,275',
    bg = 'LightBlue3',
    fg = 'grey22',
    font = ('Comic Sans',25),
)
