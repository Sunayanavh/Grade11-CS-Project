...
label2 = tk.Label(
    text = "Hawaii is an island state in the Western United States, \
about 2,000 miles from the U.S. \n mainland in the Pacific Ocean. It \
is the only U.S. state outside North America, \n the only one which is\
an archipelago, and the only one in the tropics",
    bg = 'lavender blush',
    fg = 'grey35',
...
test1 = ImageTk.PhotoImage(Image.open('hawaii1.jpg'))
labelimg1 = tk.Label(image=test1)
labelimg1.place(relx=0.9,rely=0.95,anchor='se')

test2 = ImageTk.PhotoImage(Image.open('hawaii2.jpg'))
...
label3 = tk.Label(
    text = 'Sensei Lanai (4.7) - Rs 1,71,133\n\
Marriotts Kauai Beach (4.5) - Rs 43,530\n\
Waikiki Grand Hotel (4.0) - Rs 14,975',
    bg = 'lavender blush',
    fg = 'grey22',
    font = ('Comic Sans',25),
)
